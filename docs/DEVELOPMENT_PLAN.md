...
| M4 | In progress | M4.1–M4.4 passed local synthetic and mocked gates; M4.4's [fresh PR fixture CI](https://github.com/OptimumAF/WhatAnimeShouldIWatch/actions/runs/36126202506) passed. M4.5–M4.8 and the milestone exit gate remain open; no ranking-quality lift has been measured. |
