...
| M1 | In progress | M1.1 and M1.6 verified locally. Runtime contracts now reject malformed graph, demo catalog, and model artifacts while retaining valid compact v1 and unversioned legacy loaders; M1.6 removed origin-wide service-worker cleanup. M1.2–M1.5, M1.7, and the exit gate remain open. |
