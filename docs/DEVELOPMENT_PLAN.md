...
| M1 | In progress | M1.1–M1.4 and M1.6 verified; M1.4 [fixture PR CI passed](https://github.com/OptimumAF/WhatAnimeShouldIWatch/actions/runs/36096376864). Runtime artifact contracts, pure recommendations, provider reads, and versioned local profiles are independently testable; M1.6 removed origin-wide service-worker cleanup. M1.5, M1.7, and the exit gate remain open. |
