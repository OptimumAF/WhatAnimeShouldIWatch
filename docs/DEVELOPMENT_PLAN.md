...
| M4 | Complete: local exit gate passed | M4.1–M4.8 passed synthetic and mocked gates. M4.8's [decision 0013](decisions/0013-franchise-diversity.md) fixes the selector and invented relevance/diversity threshold; the full local gate passed 52 pipeline, 70 web unit, 10 ML, 5 workflow, and 57 browser cases. Earlier M4.4–M4.7 fixture PR CI runs passed; M4.8's fresh PR CI is pending. M5 still owns permitted split-first ranking evaluation, and provider rights/publication remain held. |
