...
- [ ] **M2.3 — Remove silent third-party proxy fallback.** Make an authorized supported provider route or explicit file import the default. Any optional third-party routing must disclose the destination and transferred data before use. Do not bypass access restrictions or rate controls.
