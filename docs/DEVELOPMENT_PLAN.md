...
| M5 | In progress | M5.1 passed a pinned synthetic raw-score split manifest, parser/partition/CLI tests, and the full local fixture gate; [decision 0014](decisions/0014-raw-interaction-splits.md) records timestamp and privacy limits. [Fresh PR fixture CI](https://github.com/OptimumAF/WhatAnimeShouldIWatch/actions/runs/36137012790) passed on implementation commit `9442a25`. M5.2–M5.9 and the milestone exit gate remain open. No model or production-data evaluation is claimed. |
