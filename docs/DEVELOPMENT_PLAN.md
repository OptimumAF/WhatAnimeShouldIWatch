...
| M4 | In progress | M4.1–M4.7 passed local synthetic and mocked gates; M4.4's [fresh PR fixture CI](https://github.com/OptimumAF/WhatAnimeShouldIWatch/actions/runs/36126202506), M4.5's [fresh PR fixture CI](https://github.com/OptimumAF/WhatAnimeShouldIWatch/actions/runs/36127825844), M4.6's [fresh PR fixture CI](https://github.com/OptimumAF/WhatAnimeShouldIWatch/actions/runs/36129899820), and M4.7's [fresh PR fixture CI](https://github.com/OptimumAF/WhatAnimeShouldIWatch/actions/runs/36132192361) passed. [Decision 0012](decisions/0012-score-explanations.md) defines M4.7's score attribution. M4.8 and the milestone exit gate remain open; no production ranking-quality lift has been measured. |
