...
| M1 | In progress | M1.6 verified: removed an obsolete origin-wide service-worker unregister loop after a browser regression reproduced its effect on a sibling app. M1.1–M1.5, M1.7, and the exit gate remain open. |
