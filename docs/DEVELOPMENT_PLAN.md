...
| M1 | In progress | M1.1 and M1.6 verified; M1.1 [fixture PR CI passed](https://github.com/OptimumAF/WhatAnimeShouldIWatch/actions/runs/36093194065). Runtime contracts reject malformed graph, demo catalog, and model artifacts while retaining valid compact v1 and unversioned legacy loaders; M1.6 removed origin-wide service-worker cleanup. M1.2–M1.5, M1.7, and the exit gate remain open. |
