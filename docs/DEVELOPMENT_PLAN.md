...
| M2 | In progress | M2.1–M2.6 and M2.9 verified locally; M2.9 fixture PR [CI passed](https://github.com/OptimumAF/WhatAnimeShouldIWatch/actions/runs/36091467488), M2.4's [fresh PR CI passed](https://github.com/OptimumAF/WhatAnimeShouldIWatch/actions/runs/36100629660), and M2.5's [fresh PR CI passed](https://github.com/OptimumAF/WhatAnimeShouldIWatch/actions/runs/36102144479). M2.6 adds transactional schema versions and restricted row/run provenance; [fresh PR CI passed](https://github.com/OptimumAF/WhatAnimeShouldIWatch/actions/runs/36104137643) on implementation commit d050981. [Decision 0001](decisions/0001-provider-data-permissions.md) records provider holds; the [M2.2 audit](audits/public-artifacts-2026-09-24.md) confirms public per-user ratings and graph edges. [Decision 0002](decisions/0002-provider-workflow-gates.md) gates future jobs once merged. [Decision 0003](decisions/0003-provider-request-policy.md) records M2.4's rate policy; [decision 0004](decisions/0004-collection-provenance.md) records M2.6's timestamp and migration rules. M2.7 remains held for permitted source content; M2.8 is the next fixture-only slice. The exit gate remains open. |
