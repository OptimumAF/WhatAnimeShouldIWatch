...
| M1 | In progress | M1.1–M1.3 and M1.6 verified locally; M1.2 [fixture PR CI passed](https://github.com/OptimumAF/WhatAnimeShouldIWatch/actions/runs/36094091753). Runtime artifact contracts, pure recommendations, provider reads, and local persistence are independently testable; M1.6 removed origin-wide service-worker cleanup. M1.4–M1.5, M1.7, and the exit gate remain open. |
