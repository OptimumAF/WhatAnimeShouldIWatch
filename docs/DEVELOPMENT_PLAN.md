...
| M2 | In progress | M2.1–M2.3 verified. [Decision 0001](decisions/0001-provider-data-permissions.md) records provider holds; the [M2.2 audit](audits/public-artifacts-2026-09-24.md) confirms public per-user ratings and graph edges. M2.4–M2.9 and the exit gate remain open. |
