...
| M1 | In progress | M1.1, M1.2, and M1.6 verified locally; M1.1 [fixture PR CI passed](https://github.com/OptimumAF/WhatAnimeShouldIWatch/actions/runs/36093194065). Runtime artifact contracts and pure recommendation functions are now independently testable; M1.6 removed origin-wide service-worker cleanup. M1.3–M1.5, M1.7, and the exit gate remain open. |
