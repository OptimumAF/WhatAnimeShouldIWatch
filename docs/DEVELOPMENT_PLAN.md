...
| M2 | In progress | M2.1–M2.3 and M2.9 verified locally. [Decision 0001](decisions/0001-provider-data-permissions.md) records provider holds; the [M2.2 audit](audits/public-artifacts-2026-09-24.md) confirms public per-user ratings and graph edges. [Decision 0002](decisions/0002-provider-workflow-gates.md) gates future jobs once merged. M2.4–M2.8 and the exit gate remain open. |
